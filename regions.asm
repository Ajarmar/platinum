    ...
    REG_HYLEG_CHKPNT_4 equ REG_POLER_CHKPNT_4+REG_POLER_CHKPNT_4_AREA
    REG_HYLEG_CHKPNT_4_AREA equ 0x110
    REG_CMDROOM_CHKPNT_NEW equ REG_HYLEG_CHKPNT_4+REG_HYLEG_CHKPNT_4_AREA
